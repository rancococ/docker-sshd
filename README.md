...
2. openeuler:passwd openssl openssh-server wget net-tools gettext zip unzip ncurses
...
docker run -it --rm --name sshd-openeuler registry.cn-hangzhou.aliyuncs.com/rancococ/sshd:openeuler "bash"
